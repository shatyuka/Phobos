...
bool Phobos::UI::ExtendedToolTips = true;
int Phobos::UI::MaxToolTipWidth = 0;
bool Phobos::UI::ShowHarvesterCounter = true;
...
DEFINE_HOOK(0x5FACDF, OptionsClass_LoadSettings_LoadPhobosSettings, 0x5)
{
	...
	// Sidebar
	{
		...
		Phobos::UI::PowerDelta_ConditionRed =
			pINI->ReadDouble(SIDEBAR_SECTION, "PowerDelta.ConditionRed", Phobos::UI::PowerDelta_ConditionRed);
	}
